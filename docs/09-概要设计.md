...
**统一计划工件**：`plan-static` 输出 `spec_fingerprint`、`semantic_fingerprint`、`planning_context`、`coverage_summary`、`runtime_static_windows`；`run --plan-json` 可直接回灌该工件，并通过 `--strict-plan-match` 做双指纹校验。
