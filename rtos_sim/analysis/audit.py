...
def _analyze_time_deterministic_ready(events: list[dict[str, Any]]) -> dict[str, Any]:
    tolerance = 1e-9
...
def build_audit_report(
    ...
    *,
    ...
    time_deterministic_proof_assets = _analyze_time_deterministic_ready(events)
    ...
    checks["time_deterministic_ready_consistency"] = {
